...
CHAT_STOP_WORDS = {
    ...
    # tamil - slang & expressions
    'poda', 'podi', 'poyi', 'po', 'vada', 'vadi', 'pongo', 'vaango',
    'aiyo', 'aiyoo', 'aiyyoo', 'aiyayo', 'aiyaiyo', 'ayyo', 'ayyoo',
    'chee', 'chi', 'cha', 'chii', 'chaee', 'shee', 'shii',
    'ada', 'adaa', 'adey', 'adei', 'ade', 'aada', 'aadaa',
    'odi', 'odii', 'odiaa', 'oda', 'odaa',
    'dei', 'deii', 'deiii', 'deiiii', 'dayy', 'dayyy',
    'machaan', 'macha', 'machan', 'machiii', 'machi', 'machhi',
    'thala', 'thalaa', 'thalaaa', 'thalaivar', 'thalaiva',
    'anna', 'annaa', 'annaaa', 'annan', 'annachi',
    'akka', 'akkaa', 'akkaaa', 'akkachi',
    'thambi', 'thambii', 'thambiiii', 'tambi', 'tambii',
    'tangachi', 'thangi', 'thangai', 'tangai',
    'mapla', 'maplaa', 'maapla', 'maaplaa', 'mappla', 'mappi',
    'kanna', 'kannaa', 'kannaaa', 'kannu', 'kannamma',
    'kutti', 'kutty', 'kuttii', 'kuttiiii',
    'ponnu', 'ponnuu', 'ponnnuu', 'ponnaaa',
    'payyan', 'paiyan', 'paiya', 'paiyaa',
    'loosu', 'losu', 'losuu', 'loosuu', 'loose',
    'mokka', 'mokkaa', 'mokkai', 'moka', 'mokaa',
    'ketta', 'kettaa', 'keta', 'ketaa',
    'mass', 'masss', 'massss', 'maas', 'maaas',
    'gethu', 'gethuu', 'gethuuu', 'ketu', 'ketuu',
    'kalakku', 'kalakkuu', 'kalakkal', 'kalakals',
    'semma', 'semmaa', 'semmaaa', 'sema', 'semaa',
    'vera', 'veraa', 'veraaa', 'vera level', 'veral',
    'kattai', 'katta', 'kattaa', 'katai', 'kataa',
    'podra', 'podraa', 'podhu', 'podhaa',
    'otha', 'odhaa', 'odha', 'othaa', 'oodha',
    'thevai', 'theva', 'thevaa', 'thevilla', 'thevla',
    'summa', 'summaa', 'summave', 'summava', 'sumava',
    'veetla', 'veetlaa', 'veetil', 'veetile', 'veetu',
    'velila', 'velilaa', 'veliye', 'veliya', 'veliyaa',
    'paaka', 'paakaa', 'pakka', 'pakkaa', 'pakalam',
    'kelambu', 'kelambuu', 'kelambunga', 'kelamba',
    'jolly', 'jollyaa', 'jollyaaa', 'jollya',
    'enjoy', 'enjoyy', 'enjoyyy', 'enjoyya',
    'scene', 'scenee', 'sceneee', 'scena', 'scenaa',
    'lite', 'litee', 'liteee', 'litea', 'liteaa',
    'matter', 'matterr', 'matteraa', 'matraa',
    'settai', 'settaa', 'seta', 'setaa', 'settayaa',
    'scene', 'scenaa', 'scenela', 'sceneaa',
    'scope', 'scopee', 'scopeaa', 'scopela',
    'doubt', 'doubtaa', 'doubtuu', 'daautaa',
    'tension', 'tensionaa', 'tensionn', 'tenshun',
    'mood', 'moodaa', 'moodd', 'moodu', 'mooduu',
    'feel', 'feelaa', 'feelu', 'feeluu', 'feeleaa',
    'plan', 'planaa', 'plann', 'plannu', 'plannuu',
    'chance', 'chanceaa', 'chancee', 'chaance',
    ...
    # tamil - more chat fillers & responses
    'seriaa', 'seriyaa', 'sariyaa', 'seridaa', 'sarida',
    'correct', 'correctaa', 'correctu', 'korekt',
    'super', 'superr', 'superrr', 'sooper', 'sooperr',
    'niceaa', 'niceu', 'naisu', 'naisuu',
    'bestaa', 'bestu', 'bestuu',
    'pooram', 'poram', 'porum', 'porumaa',
    'wait', 'waitaa', 'waitu', 'waituu', 'veyt',
    'coming', 'comingaa', 'komingu', 'komingg',
    'done', 'doneaa', 'doneu', 'donnu',
    'okda', 'okdi', 'okdaa', 'okdii', 'okayda',
    'fineaa', 'fineu', 'finee', 'fainu',
    'ready', 'readyaa', 'readyu', 'redi', 'redyaa',
    'sure', 'sureaa', 'sureu', 'shure', 'shur',
    'yov', 'yovv', 'yovvv', 'yo', 'yoo', 'yooo',
    'machaaa', 'machaaaa', 'machaaan', 'machaaaan',
    'brooo', 'broooo', 'bruhhhh', 'bruhhhhh',
    'ennadaa', 'ennadii', 'ennaaaa', 'ennadaaa',
    'pannidren', 'pannidalam', 'panniduven', 'pannidu',
    'sollidu', 'sollidren', 'solliduven', 'sollidum',
    'paathidu', 'paathidren', 'paathiduven', 'paathidum',
    'varuvom', 'varuven', 'varuvaa', 'varuvanga',
    'poittu', 'poitu', 'poittutu', 'poitutu',
    'vandhuttu', 'vandutu', 'vandhutu', 'vandhitu',
    'pannitu', 'pannittu', 'pannidu', 'pannidum',
    'sollitu', 'sollittu', 'sollidum', 'sollidu',
    'kedaikum', 'kedaikkum', 'kidaikkum', 'kidaikum',
    'venumna', 'venumnaa', 'vendumnaa', 'vendumna',
    'illana', 'illanaa', 'illaina', 'illainaa',
    'aanalum', 'aanaalum', 'analum', 'anaalum',
    'kooda', 'koodaa', 'kuda', 'kudaa', 'koodave',
    'mattum', 'mattumey', 'mathum', 'mathumey',
    'pakkathula', 'pakkathla', 'pakathla', 'pakathula',
    'munnadhi', 'munnadi', 'munnala', 'munnalaa',
    'pinnadhi', 'pinnadi', 'pinnala', 'pinnalaa',
    'ulle', 'ulleye', 'ullaye', 'ulla', 'ullaa',
    'veliye', 'veliyeye', 'veliyaye', 'veliya', 'veliyaa',
    'mela', 'melaa', 'mele', 'melee', 'meley',
    'keela', 'keelaa', 'keele', 'keelee', 'keeley',
    'paathuko', 'paathukoo', 'paathuko', 'pathuko',
    'pannuko', 'pannukoo', 'paniko', 'panikoo',
    'solluko', 'sollukoo', 'soluko', 'solukoo',

    # tamil - more exclamations & reactions
    'thoo', 'thooo', 'thoooo', 'thu', 'thuu',
    'sho', 'shoo', 'shooo', 'shoooo',
    'noo', 'nooo', 'noooo', 'nooooo',
    'yaa', 'yaaa', 'yaaaa', 'yaaaaa',
    'haa', 'haaa', 'haaaa', 'haaaaa',
    'uff', 'ufff', 'uffff', 'uffffff',
    'aah', 'aahh', 'aahhh', 'aaahhh',
    'ooh', 'oohh', 'oohhh', 'ooohhh',
    'eww', 'ewww', 'ewwww', 'ewwwww',
    'che', 'chee', 'cheee', 'cheeee',
    'mmm', 'mmmm', 'mmmmm', 'mmmmmm',
    'aaah', 'aaaah', 'aaaaah', 'aaaaaah',
    'ooof', 'oooof', 'ooooof', 'oooooof',
    'ayoo', 'ayooo', 'ayoooo', 'aiyooo',
    'daa', 'daaa', 'daaaa', 'daaaaa',
    'dii', 'diii', 'diiii', 'diiiii',
    'thala', 'thalaaa', 'thalaaaa', 'thalaivaa',
    'kekaa', 'kekaaaa', 'kekaaa', 'kethu',
    'adchaa', 'adchaam', 'atcha', 'atchaa',
    'apdiyaa', 'apidiyaa', 'apudiya', 'appudiya',
    'ipudiyaa', 'ipidiyaa', 'ippudiya', 'ippidiya',
    'ennadhu', 'ennudhu', 'ennadha', 'ennadhaa',
    'apdina', 'apudina', 'appudina', 'appidina',
    'ipdina', 'ipudina', 'ippudina', 'ippidina',
    ...
    'll', 've', 're', 'nt', 'em', 'ill', 'ull', 'yall','poda', 'podi', 'poda', 'poyi', 'po', 'vada', 'vadi',
    'da', 'dei', 'di', 'dey', 'ra', 'ri',
    ...
    'oru', 'onnu', 'onna', 'ore', 'iruku', 'irukku', 'irukkum', 'iruka', 'irukka', 'illa', 'illai',
